# FastestJSONInTheWest - Detailed Documentation
...
- [LINQ_IMPLEMENTATION.md](LINQ_IMPLEMENTATION.md) - Query interface details
- [UTF16_UTF32_IMPLEMENTATION.md](UTF16_UTF32_IMPLEMENTATION.md) - UTF-16/32 handling
- [NUMA_IMPLEMENTATION.md](NUMA_IMPLEMENTATION.md) - Multi-socket optimization
- [FUTURE_WORK_STATUS.md](FUTURE_WORK_STATUS.md) - Roadmap and completion status
...
# Comparative benchmark (FJITW vs simdjson)
./benchmarks/comparative_benchmark
```
